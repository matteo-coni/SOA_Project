...
int singlefilefs_fill_super(struct super_block *sb, void *data, int silent) {   
    ...
    #if LINUX_VERSION_CODE <= KERNEL_VERSION(5,12,0) //add for version dependance
    ...
    #endif//set the root user as owner of the FS root
...
MODULE_DESCRIPTION("SINGLE-FILE-FS, module created by Francesco Quaglia <francesco.quaglia@uniroma2.it>, extended by Matteo Coni for Reference_Monitor");
